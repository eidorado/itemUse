...
<html>
  ...
  <body class="easyui-layout">
 	 ...
 	 <form id="searchForm">
        <p class="ui-fields">
			<label class="ui-label">概念板块名称:</label><input name="platename" class="easyui-box ui-text" style="width:100px;">
     ...
     <div id="edit-win" class="easyui-dialog" title="概念板块" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:380px;">  
  	 ...
  	 <script type="text/javascript" src="<%=basePath%>/view/stocks/company/page-tConceptPlate.js"></script>
  </body>
</html>
