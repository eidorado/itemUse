...
<!--   排序.end -->
  ...
  <script type="text/javascript">
		...
		function openOther(c,d){
			location.href="aboutDetail?picId="+c+"&title="+d;
		}
  ...
  <body>
     <h2 align="center"><a href="back">关于我们</a></h2>
	  ...
	  <input type="submit" onclick="openOther(2,'我们团队')" value="我们团队" style="padding: .2em 1em;">
	  <input type="submit" onclick="openOther(3,'我们荣誉')" value="我们荣誉" style="padding: .2em 1em;">
	  ...
	  <table id="tableList">
	   ...
	   <div class="pageClass" align="center">
			...
			<s:if test="#request.page.hasPrePage">
				<a href="aboutDetail?currentPage=1&picId=${picId}&title=${title}">首页</a>
				<a href="aboutDetail?currentPage=${page.currentPage -1 }&picId=${picId}&title=${title}">上一页</a>
			</s:if>
			<s:else>
				首页
				上一页
			...
			<s:if test="#request.page.hasNextPage">
				<a href="aboutDetail?currentPage=${page.currentPage + 1 }&picId=${picId}&title=${title}">下一页</a>
				<a href="aboutDetail?currentPage=${page.totalPage }&picId=${picId}&title=${title}">尾页</a>			
			</s:if>
			<s:else>
				下一页
				尾页
			...
			<div style="width:700px;height:670px;">
		     ...
		     <div style="position:absolute;width:700px;height:600px; overflow:auto;top:55px;">
	            <form id="fm2" action="" method="post" enctype="multipart/form-data">
	                ...
	                <input type="hidden" name="fileType" id="fileType" value="2"/> <!-- 判断哪种文件,2TFBOYS的生活详情文件 -->
