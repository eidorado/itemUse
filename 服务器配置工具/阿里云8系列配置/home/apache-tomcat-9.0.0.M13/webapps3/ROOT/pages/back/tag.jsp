...
<html>
  ...
  <script type="text/javascript">
  		...
  		function del(){
  			...
  			location.href="tagDel?currentPage=${page.currentPage}&ids="+value;
		 }
	  ...
	  <table id="tableList">
	   ...
	   <div class="pageClass" align="center">
			...
			<s:if test="#request.page.hasPrePage">
				<a href="tag?currentPage=1">首页</a>
				<a href="tag?currentPage=${page.currentPage -1 }">上一页</a>
			</s:if>
			<s:else>
				首页
				上一页
			...
			<s:if test="#request.page.hasNextPage">
				<a href="tag?currentPage=${page.currentPage + 1 }">下一页</a>
				<a href="tag?currentPage=${page.totalPage }">尾页</a>			
			</s:if>
			<s:else>
				下一页
				尾页
       ...
       <!--弹出层开始-->
		<div id="Idiv1" style="display:none; position:absolute; z-index:1000; background:#67a3d9;">
            ...
            <form id="fm" action="tagSave" method="post">
               <table>
                <tr>
                    <td>标签名称：</td>
                    <td><input type="text" id="tagName" name="tag.tagName" style="width:540px" maxlength="50"></input></td>
                </tr>
                <tr>
                    <td>标签备注：</td>
                    <td><textarea id="tagRemak" name="tag.tagRemak" rows="20" cols="20" style="width:540px;height:60px;" maxlength="100"></textarea>
                    </td>
                </tr>
                </table>
                <input type="hidden" name="tag.id" id="id" />
