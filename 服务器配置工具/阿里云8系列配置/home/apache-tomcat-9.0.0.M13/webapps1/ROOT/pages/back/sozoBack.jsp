...
<html>
  ...
  <script type="text/javascript">
  		...
  		function turnHref(c){
  			if(c=='1'){
  				location.href="sozoPicMag";
  			}else if(c=='2'){
  				location.href="sozoTag";
  			}else if(c=='3'){
  				...
  				location.href="sozoAboutDetail?picId=1&title=关于我们";
  			}
  		}
  </script>
  <body style="margin:0">
    <div id="container"  align="center">
    	<div id="scene">
    		<!-- <img src="images/sozoBack/contact.jpg" alt="" width="100%"> -->
    		<h1 style="position:-20 0 0 0">素造后台控制中心<font size="5px">&nbsp;&nbsp;&nbsp;&nbsp;${nickname}</font></h1>
    	</div>
