	  ...
	  <table id="tableList">
	   ...
	   <div class="pageClass" align="center">
			...
			<s:if test="#request.page.hasPrePage">
				<a href="sozoPicDetail?currentPage=1&picId=${picId}&title=${title}">首页</a>
				<a href="sozoPicDetail?currentPage=${page.currentPage -1 }&picId=${picId}&title=${title}">上一页</a>
			</s:if>
			<s:else>
				首页
				上一页
			...
			<s:if test="#request.page.hasNextPage">
				<a href="sozoPicDetail?currentPage=${page.currentPage + 1 }&picId=${picId}&title=${title}">下一页</a>
				<a href="sozoPicDetail?currentPage=${page.totalPage }&picId=${picId}&title=${title}">尾页</a>			
			</s:if>
			<s:else>
				下一页
				尾页
			...
			<div style="width:700px;height:670px;">
			 <div id="Idiv3_head" >
				 ...
				 <div style="float:left;">
			    	 <h3 style="margin-left:20px;">项目详情排序</h3>
			     </div>
				 <div style="float:right;">
